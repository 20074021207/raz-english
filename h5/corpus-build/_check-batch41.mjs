...
// 复刻 audit-corpus.mjs 的精确校验逻辑，仅针对 batch-41 + 跨批次查重
...
const batch = JSON.parse(readFileSync(dir + 'batch-41.json', 'utf8'));
const wordList = JSON.parse(readFileSync(dir + 'words-batch-41.json', 'utf8'));
