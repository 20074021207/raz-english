...
// 复刻 audit-corpus.mjs 的精确校验逻辑，仅针对 batch-27 + 跨批次查重
...
const batch = JSON.parse(readFileSync(dir + 'batch-27.json', 'utf8'));
const wordList = JSON.parse(readFileSync(dir + 'words-batch-27.json', 'utf8'));
